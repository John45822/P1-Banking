...
public enum Menu {
     ...
     */
    MainMenu(new String[]{ "Account Login", "Bank Login", "Create New Bank", "Exit" }, 1),
    ...
    /**
     * Bank.Bank Services menu options.
     */
    BankServicesMenu(new String[]{ "Savings Account", "Credit Account", "Logout" }, 30),
     ...
     */
    SavingsAccountMenu(new String[]{ "Fund Transfer", "Withdrawal", "Deposit", "Back to Main Menu" }, 51);
